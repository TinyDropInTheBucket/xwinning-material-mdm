...
public class ManufacturerApiPathConst extends ApiBaseConst {
     ...
     * 新增生产厂家信息
     */
    public static final String ADD_MANUFACTURER_DETAIL_INFO = BASE_TYPE_CONTEXT + BASE_VERSION + BASE_MODEL_CONTEXT  + "/manufacturer/add/by_example";

    /**
     * 修改生产厂家信息
     */
    public static final String MODIFY_MANUFACTURER_DETAIL_INFO = BASE_TYPE_CONTEXT + BASE_VERSION + BASE_MODEL_CONTEXT  + "/manufacturer/modify/by_example";
